...
test.describe("Handle Dropdown, Checkbox, Radio Buttons, Mulitple Selection @smoke", () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    test("Handle Checkbox @regression", async ({ page }) => {
        ...
        const allCheckboxes = await page.locator("//div[@class='interests-div']//div/label").all();
    ...
    test("Handle Radio Buttons @regression", async ({ page }) => {
        const radioButtonsLocator = page.locator("//div[contains(@class,'genders-div')]//input");
        ...
        const texts = await page.locator("//div[contains(@class,'genders-div')]//label").allTextContents();
