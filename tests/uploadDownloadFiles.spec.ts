...
test("Upload Single file test", async ({page}) =>{
    ...
    await page.locator("#file-upload").setInputFiles("C:\\Users\\DELL\\Downloads\\upload\\samplefile12.txt");
...
test("File download test", async ({page}) =>{
    ...
    await download.saveAs("C:\\Users\\DELL\\Downloads\\" + download.suggestedFilename());
